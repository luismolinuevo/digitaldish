          ...
          <div className="">
            <div className="flex justify-between mb-4">
              <button 
                ...
                className="px-4 py-2 text-md font-bold text-gray-600 bg-white rounded-sm focus:outline-none w-22 border border-[]">Log in
              </button>
              <button 
                onClick={handleToggle}
                className="px-2 py-2 text-md font-bold text-gray-600 bg-[#C7A695] focus:outline-none border border-[#C7A695] w-22">Sign up
              </button>
            </div>
          </div>
        </div>
