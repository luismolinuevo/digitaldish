    ...
    <div className="border border-orange-400 ">
      <div className=" text-center mt-20 py-20 mx-auto">
        ...
        <div class="flex justify-center mt-10">
          ...
          >
            Bid
            <img src={Bidpic} className=" h-[230px] w-[260px] ml-[60px] mt-[30px]"
            />
          </button>
          ...
          >
            Negotiate
            <img src={Negpic} className=" h-[200px] w-[210px] ml-28 mt-[30px]"
            />
          </button>
          ...
          >
            Barter
            <img src={Barterpic} className=" h-[220px] w-[240px] ml-[75px] mt-[30px]" />
          </button>
        </div>
